<h2> Algorithms used for resolution // Algorítmos usados para resolução </h2>
<br>
<h3><b> <em>🗃️ About project: </em> </b> </h3>
<p> • The use of these algorithms was extremely important to solve some questions of the P.O.O test, so I decided to put them here so that
I can use them later, in case I lose. </p> <br>
